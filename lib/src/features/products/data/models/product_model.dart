import 'package:dhgc_mobilio_app/src/features/products/data/datasources/mappers/entity_convertable.dart';
...
class ProductModel extends Equatable
    with EntityConvertible<ProductModel, ProductEntity> {
  final int id;
  final String name;
  final double price;
